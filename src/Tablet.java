...
public class Tablet extends Prodotti{
    ...
    public Tablet(EnumProdottiElettronici tipo, String produttore, String modello, BigDecimal prezzo, String descrizione, Double dimensioneDisplay, Integer dimensioneSpazioArchiviazione) {
